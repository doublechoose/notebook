...
requirejs([
    ...
    'base/js/promises',
    'auth/js/loginwidget',
    'alnotebook/js/maintoolbar',
    'alnotebook/js/pager',
    'alnotebook/js/promises',
    'alnotebook/js/quickhelp',
    'alnotebook/js/menubar',
    'alnotebook/js/notificationarea',
    'alnotebook/js/savewidget',
    'alnotebook/js/actions',
    'alnotebook/js/keyboardmanager',
    'alnotebook/js/kernelselector',
    'codemirror/lib/codemirror',
    'alnotebook/js/about',
    'alnotebook/js/searchandreplace',
    'alnotebook/js/clipboard',
    'bidi/bidi'
], function(
    $,
    contents_service,
