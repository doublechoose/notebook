...
define([
    ...
    OutputArea.prototype.style = function () {
        ...
        this.wrapper.addClass('al_output_wrapper');
    ...
    OutputArea.prototype.handle_output = function (msg) {
        console.log("yoyo [handle_output] type="+msg.header.msg_type);
        var json = {};
    ...
    OutputArea.prototype.append_output = function (json) {
        this.expand();
        console.log("[append_output] json= "+json);
